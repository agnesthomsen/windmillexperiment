...
\begin{figure}
  \centering
  %\includegraphics[width=0.5\textwidth]{img/solder.png}
  \caption{Soldering the wires to the DC motor.}
  \label{figure:soldering}
\end{figure}
\begin{figure}
  \centering
  %\includegraphics[width=0.5\textwidth]{img/turbine.png}
...
\begin{figure}
  \centering
  %\includegraphics[width=0.5\textwidth]{img/finalsetup.png}
...
\begin{figure}
\centering
%\includegraphics[width=0.5\textwidth]{img/windvsdistance.png}
...
\begin{figure}
\centering
%\includegraphics[width=0.5\textwidth]{img/ohmslaw.png}
...
\begin{figure}
  \centering
  %\includegraphics[width=0.5\textwidth]{img/FinalPlot.pdf}
